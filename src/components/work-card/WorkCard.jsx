...
const WorkCard = ({ info }) => { // Destructuring the info prop passed by the work parent.
    return (
        <div className='WorkCard'>
            <Container fluid>
                <Row>
                    <Col className="d-flex flex-row bg-light px-3 py-4 border-bottom border-secondary border-2">

                        {
                        //div contains the picture.
                        }

                        <div className="photo bg-light"><img src={info.photo} className="img-fluid rounded" alt="" /></div>
